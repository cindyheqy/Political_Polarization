...
def get_roll_call_polarity():
    ...
    polarity_df.to_csv('/Users/guangbo_niu/Library/Mobile Documents/com~apple~CloudDocs/Academics/Autumn 2022/DPPP 2/Political_Polarization/tables/polarity.csv')
    return polarity_df

if __name__ == "__main__":
    import sys
    get_roll_call_polarity()